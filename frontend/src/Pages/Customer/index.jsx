...
const Customer = () => {
    ...
    return (
        <div className="max-w-6xl mx-auto px-3 lg:px-0 text-white py-5 md:py-12 lg:py-16 flex flex-col gap-10">
            ...
            <div className="">
                <p className='underline underline-offset-4 decoration-primary my-3'>Vendor List :</p>
                <div className="py-3 px-2 flex gap-3 bg-white rounded">
                    <div className="w-auto flex justify-center items-center overflow-hidden rounded">
                    ...
                    <div className="flex-1 flex flex-col gap-[6px] text-black">
                        ...
                        <Link to="/order" className='bg-primary text-white w-fit px-3 rounded py-1'>Choose this vendor</Link>
                    </div>
                </div>
            </div>
        </div>
